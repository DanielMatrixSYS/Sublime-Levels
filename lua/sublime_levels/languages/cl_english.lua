Sublime.Languages["en"] = 
{
    ...
    -- Leaderboards
        ...
        leaderboards_set_level_desc     = "What level do you want to set '%s' to?",
        ...
        leaderboards_change_user        = "Change leaderboard nickname",
        leaderboards_change_user_tip    = "This will change the username of the player to the given value.",
        leaderboards_change_user_desc   = "What do you want to change the nickname of '%s' to?",
        leaderboards_change_user_title  = "Change Username",
        leaderboards_give_xp            = "How much experience do you want to give '%s'?",
        leaderboards_give_skill_desc    = "How many skill points do you want to give '%s'?",
        leaderboards_take_skill_desc    = "How many skill points do you want to take from '%s'?",
        leaderboards_reset_user_desc    = "Are you sure you want to reset the user data of '%s'?\nThis can't be undone.",
    --
    ...
    -- Skills
        ...
        skills_current_bonus    = "%s - %s/%s - Current bonus: %s%%",
        skills_upgrade          = "Upgrade",
        skills_unlock_next      = "Are you sure you want to upgrade %s?",
        skills_unable           = "You are unable to upgrade this skill.",
        skills_you_dont_have    = "You don't have enough skill points to upgrade this skill.",
        skills_unable_you       = "Unable",
        skills_you_have         = "You have to level up first.",
        skills_reset            = "Reset skills",
        skills_physical         = "Physical",
        skills_movement         = "Movement",
        skills_weapons          = "Weapons",
        skills_darkrp           = "DarkRP",
        skills_ttt              = "Trouble In Terrorist Town",
        skills_other            = "Other",
        skills_reset_conf       = "Are you sure you want to reset your skills?\nThis can't be undone.",
    --
